"""Tests for hermes_plugin hooks."""

import os
from unittest.mock import patch

from hermes_plugin.hooks import _flush_session, _get_plugin_config
...
def test_flush_session_recursion_guard():
    ...
    try:
        with patch("hermes_plugin.hooks.subprocess.run") as mock_run:
